...
test('simple', t => {
                     ...
                     t.is(result.code, 0);
                     t.is(result, bottomOfFile1.slice(0, 10).reverse().join('\n') + '\n');
});
...
test('multiple files', t => {
                     ...
                     t.is(shell.error(), null);
                     t.is(result.code, 0);
                     t.is(result, bottomOfFile2.slice(0, 10).reverse().concat(
...
test('Globbed file', t => {
                     ...
                     t.is(shell.error(), null);
                     t.is(result.code, 0);
                     t.is(result, bottomOfFile1.slice(0, 10).reverse().concat(
...
test('With `\'-n\' <num>` option', t => {
                     ...
                     t.is(shell.error(), null);
                     t.is(result.code, 0);
                     t.is(result, bottomOfFile2.slice(0, 4).reverse().concat(
